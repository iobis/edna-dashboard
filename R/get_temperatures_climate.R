...
get_temperatures_climate <- function(force = FALSE) {

  if (!file.exists("data/climate_historical.txt") || force) {
    message("Getting historical climate...")
    ...
    message("Historical climate already present")
  }
