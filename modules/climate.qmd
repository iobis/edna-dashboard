...
selectInput("iucnClimate", "IUCN category:", iucn_names)
...
::: {.card title="How this data is extracted?"}

<img src="images/examples/climate_data_example.jpg" style="display: block; margin-left: auto; margin-right: auto; width:60%">
