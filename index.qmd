...
library(glue)
library(fs)
photos = c("https://images.ecycle.com.br/wp-content/uploads/2021/05/20195924/o-que-e-paisagem.jpg",
           "https://static.todamateria.com.br/upload/pa/is/paisagem-natural-og.jpg")

cat("<div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr));grid-gap: 1em;'>")
# for (i in seq_along(photos)){
#   cat(glue('<img src="{{photos[i]}}" style="display:block; width:100%;">', .open = "{{", .close = "}}"))
#   
# }
cat("![](https://images.ecycle.com.br/wp-content/uploads/2021/05/20195924/o-que-e-paisagem.jpg)") 
cat("![](https://static.todamateria.com.br/upload/pa/is/paisagem-natural-og.jpg)")
cat("</div>")
````
...
# TODO: change this to be done once, when the document is assembled
sites <- jsonlite::read_json("https://raw.githubusercontent.com/iobis/edna-tracker-data/data/generated.json")
sites_list <- sites$sites
sites_samples <- sites$samples
